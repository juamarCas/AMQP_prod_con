...
class Producer: public IAMQP{
    ...
    public: 
        ...
        */
        ...
        Producer(const std::string& user, const std::string& password, const std::string& host, const std::string& vhost, const std::string& exchange, IAMQP::QEConf conf, P_callbacks& callbacks);
